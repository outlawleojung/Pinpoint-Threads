...
1) keep: 아래 3가지 조건을 모두 만족?
   (a) **패션·뷰티·라이프스타일 유행템** (사용자 방침 2026-09-02: 평범 일상용품 X · 패션 트렌드 O)
   (b) **여성 또는 중성 대상** (남성 특화 X — 남성 헤어밴드·남자 손목시계·남자 골프용품 등 배제)
   (c) **트렌드성·감각·신상 요소 강함** — SNS 에서 화제되고 있거나 될 만한 것
       매일 쓰는 흔한 실용템 X

   자동 drop 대상 (확대):
   - 정치·시사·인물·스포츠·TV 프로 · 뉴스 이슈 · 투자 · 성인 · 의약품
   - 김치·반찬·전통음식·간편식·밀키트·건강기능식품·건강식품 · 자동차 · 부동산 · 성인 취미
   - 남성 특화 (남자 신발·남자 시계·남자 운동복 등)
   - **평범 일상용품 (양말·쿨토시·마스크·수선용품·러닝벨트·헤어밴드·주방용품·청소용품 등)**
   - **주방/조리 도구·냄비·프라이팬·에어프라이어·밀프렙**
   - **홈·인테리어 기본템**

   keep 대상 (좁게):
   - 여성/중성 **패션 신상** (예: 신상 운동화, 트렌디한 가방, 최신 아우터/셋업, 액세서리)
   - **뷰티 유행템** (예: 화제 립·아이섀도우 팔레트·향수 신상)
   - **감성·트렌디 소품** (오브제·향초 신상)
   - **밈성·바이럴 요소** 강한 것
