...
**AI 콘텐츠 인텔리전스 시스템.** 자동화가 아니라, 터진 게시글의 "왜 터졌는가"를 AI가 분석·재생산하는 것이 핵심. 프롬프트 튜닝 품질 = 수익. 상세: [docs/00-overview/vision.md](docs/00-overview/vision.md)
...
- 계정 정지 리스크가 있는 자동화는 절대 금지 (비공식 API, 브라우저 자동화로 팔로우 등 금지)
